...
public class ShowMostOftenBoughtProductTests {
    ...
    @Test
    @DisplayName("if return most often bought product successful")
    public void test1() {
        Assertions.assertEquals(czapka, marketService.showMostOftenBoughtProduct()
        );
    }

    @Test
    @DisplayName("if purchases is null does not return exception")
    public void test2 (){
        purchases = null;
        Assertions.assertDoesNotThrow(() -> marketService.showMostOftenBoughtProduct());
    }

    @Test
    @DisplayName("if return most often bought product not successful")
    public void test3(){
        Assertions.assertNotEquals(timer,marketService.showMostOftenBoughtProduct());
    }
