...
public class ShowLeastOftenBoughtProductTests {
    ...
    @Test
    @DisplayName("if returning the least often bought product is correct")
    public void test1(){
        Assertions.assertEquals(timer,marketService.showLeastOftenBoughtProduct());
    }
