...
public class WhoSpentTheMostTests {
    ...
    @Test
    @DisplayName("if the most spent person is correct")
    public void test1() {
        Assertions.assertEquals(jan, marketService.whoSpentTheMost());
    }

    @RepeatedTest(10)
    public void test2() {
        Assertions.assertTimeout(Duration.ofMillis(3), () -> {
            marketService.whoSpentTheMost();
        });
    }
